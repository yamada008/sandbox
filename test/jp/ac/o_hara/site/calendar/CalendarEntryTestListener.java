...
public class CalendarEntryTestListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent arg0) {
		if (System.getenv("DATABASE_URL") != null) {
			dao.execSQL("CREATE TABLE IF NOT EXISTS calentry (id SERIAL, date DATE, userID VARCHAR(64), moduleName VARCHAR(32), PRIMARY KEY (id))");
		} else {
			if (dao.execSQL(
					"CREATE TABLE IF NOT EXISTS calentry (id IDENTITY, date DATE, userID VARCHAR(64), moduleName VARCHAR(32))")) {
